...
window.NCD_POT_PLANT_LANGUAGES.test = {
  code: "test",
  name: "Test Language",
  ...
  */
  ...
  /*
    CLEAN VIEWER
  */
  watchGrow: "TEST — Watch it grow",
  watchAgain: "TEST — Watch again",
  ...
  */
  ...
  qcs: {
    LR: {
      ...
      labelScale: 1,
      heartQuestion: "TEST — Do I really belong here?",
      description:
        "TEST — Loving relationships create a community where people experience genuine acceptance, care and belonging."
    },

    EL: {
      lines: [
        { text: "Leadership TEST", emphasis: false },
        { text: "Empowering TEST", emphasis: true }
      ],
      labelScale: 1,
      heartQuestion: "TEST — Do you really believe in me?",
      description:
        "TEST — Empowering leaders recognise people's God-given potential and help them grow into meaningful responsibility."
    },
