...
window.NCD_POT_PLANT_LANGUAGES.de = {
  ...
  interface: {
    ...
    surveyScores: "Umfragewerte",
    replaySpiral: "Spirale wiederholen",
    randomResult: "Zufälliges Ergebnis",
    closeScoresTest: "Ähnliche Werte testen",
    balancedResult: "Ausgeglichenes Ergebnis",

    maximumFactor: "Maximumfaktor",
    minimumFactor: "Minimumfaktor",

    watchGrow: "Beim Wachsen zusehen",
  ...
  qcs: {
    ...
    IWS: {
      name: "Inspirierender Gottesdienst",
      lines: [
    ...
    HSG: {
      name: "Ganzheitliche Kleingruppen",
      lines: [
