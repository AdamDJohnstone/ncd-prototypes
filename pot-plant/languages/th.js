...
window.NCD_POT_PLANT_LANGUAGES.th = {
  ...
  qcs: {
    LR: {name:"ความสัมพันธ์ที่เปี่ยมด้วยความรัก",lines:[{text:"ความสัมพันธ์",emphasis:false},{text:"ที่เปี่ยม",emphasis:true},{text:"ด้วยความรัก",emphasis:true}],heartQuestion:"ฉันเป็นส่วนหนึ่งของที่นี่จริง ๆ หรือไม่?",description:"ความสัมพันธ์ที่เปี่ยมด้วยความรักสร้างชุมชนที่ผู้คนสัมผัสได้ถึงการยอมรับ การเอาใจใส่ และการเป็นส่วนหนึ่งอย่างแท้จริง"},
    EL: {name:"ภาวะผู้นำที่เสริมสร้างพลัง",lines:[{text:"ภาวะผู้นำ",emphasis:false},{text:"ที่เสริมสร้าง",emphasis:true},{text:"พลัง",emphasis:true}],heartQuestion:"คุณเชื่อมั่นในตัวฉันจริง ๆ หรือไม่?",description:"ภาวะผู้นำที่เสริมสร้างพลังมองเห็นศักยภาพที่พระเจ้าประทานแก่แต่ละคน และช่วยให้พวกเขาเติบโตสู่ความรับผิดชอบที่มีความหมาย"},
    ...
    GBM:{name:"การรับใช้ตามของประทาน",lines:[{text:"การรับใช้",emphasis:false},{text:"ตาม",emphasis:true},{text:"ของประทาน",emphasis:true}],heartQuestion:"ฉันมีบางสิ่งที่จะมีส่วนร่วมจริง ๆ หรือไม่?",description:"การรับใช้ตามของประทานช่วยให้ผู้คนค้นพบว่าพระเจ้าทรงประทานความสามารถเฉพาะแก่พวกเขาอย่างไร และพบวิธีที่มีความหมายในการมีส่วนร่วม"},
    NOE:{name:"การประกาศข่าวประเสริฐที่เข้าถึงความต้องการของผู้คน",lines:[{text:"การประกาศ",emphasis:false},{text:"ข่าวประเสริฐ",emphasis:false},{text:"ที่เข้าถึงความต้องการ",emphasis:true},{text:"ของผู้คน",emphasis:true}],heartQuestion:"คุณใส่ใจฉันจริง ๆ หรือไม่?",description:"การประกาศข่าวประเสริฐที่เข้าถึงความต้องการของผู้คนเริ่มต้นจากการมองเห็นผู้คนที่พระเจ้าทรงนำมาไว้รอบตัวเราอย่างแท้จริง และตอบสนองต่อความต้องการของพวกเขา"},
    IWS:{name:"การนมัสการที่สร้างแรงบันดาลใจ",lines:[{text:"การนมัสการ",emphasis:false},{text:"ที่สร้างแรง",emphasis:true},{text:"บันดาลใจ",emphasis:true}],heartQuestion:"ฉันได้พบพระเจ้าที่นี่จริง ๆ หรือไม่?",description:"การนมัสการที่สร้างแรงบันดาลใจช่วยให้ผู้คนพบพระเจ้าในแบบที่ฟื้นฟูความเชื่อ ความหวัง และความพร้อมที่จะตอบสนอง"},
